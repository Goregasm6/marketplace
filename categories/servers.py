...
class ServersCategory(CategoryKnowledge):
    ...
    keywords = ("server", "rackmount", "blade", "poweredge", "proliant", "xeon", "raid", "nas", "san")
    ...
    repair_opportunities = ("replace failed drives", "add RAM", "firmware update", "fan or power-supply replacement")
    shipping_profile = ShippingProfile("heavy", "freight or double-boxed insured ground", "Confirm rails, drives, and licensing; pack against rack-ear damage.")

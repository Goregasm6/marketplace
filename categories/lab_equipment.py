...
class LabEquipmentCategory(CategoryKnowledge):
    ...
    brands = ("Thermo Fisher", "Agilent", "Eppendorf", "Bio-Rad", "VWR", "Mettler Toledo", "Shimadzu")
    keywords = ("pipette", "centrifuge", "incubator", "spectrometer", "chromatograph", "microscope", "balance")
    common_misspellings = ("ependorf", "centrifuge", "spectrophotometer", "chromotograph")
    seasonality = "University surplus is common after academic terms; research procurement runs year-round."
    repair_opportunities = ("calibration", "lamp replacement", "seal replacement", "motor service")
    shipping_profile = ShippingProfile("specialized", "foam-packed freight or insured parcel", "Require decontamination documentation and protect sensitive optics.")

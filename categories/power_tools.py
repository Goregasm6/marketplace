...
class PowerToolsCategory(CategoryKnowledge):
    ...
    keywords = ("drill", "impact driver", "circular saw", "miter saw", "battery", "tool kit", "compressor")
    ...
    repair_opportunities = ("battery recell", "brush replacement", "switch repair", "chuck replacement")
    shipping_profile = ShippingProfile("medium", "insured ground parcel", "Ship batteries compliantly and test chargers before listing.")

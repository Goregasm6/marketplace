...
class WatchesCategory(CategoryKnowledge):
    ...
    brands = ("Rolex", "Omega", "Seiko", "Hamilton", "Tissot", "Citizen", "Casio", "Tag Heuer")
    keywords = ("watch", "chronograph", "automatic", "diver", "wristwatch", "bezel", "movement")
    ...
    repair_opportunities = ("battery replacement", "crystal replacement", "bracelet resizing", "movement service")
    shipping_profile = ShippingProfile("small", "signature-required insured parcel", "Authenticate high-value pieces and photograph serial/reference numbers.")

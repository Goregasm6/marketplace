...
class AudioCategory(CategoryKnowledge):
    ...
    brands = ("Marantz", "Pioneer", "Technics", "Bose", "Yamaha", "Denon", "Klipsch", "Sennheiser")
    keywords = ("receiver", "turntable", "speaker", "amplifier", "headphones", "mixer", "microphone", "subwoofer")
    ...
    repair_opportunities = ("refoam drivers", "capacitor recap", "belt replacement", "contact cleaning")
    shipping_profile = ShippingProfile("medium", "double-boxed insured parcel", "Protect cones and platters; oversized speakers are often local-pickup candidates.")

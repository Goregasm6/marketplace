...
class GamingCategory(CategoryKnowledge):
    ...
    brands = ("Nintendo", "Sony", "Microsoft", "Valve", "Sega", "Atari")
    keywords = ("playstation", "xbox", "nintendo", "switch", "gamecube", "console", "controller", "game boy")
    ...
    repair_opportunities = ("stick-drift repair", "disc-drive cleaning", "shell replacement", "battery replacement")
    shipping_profile = ShippingProfile("small", "tracked parcel with insurance", "Test controllers, remove accounts, and document serial numbers.")
    ...
    related_categories = ("electronics", "collectibles")

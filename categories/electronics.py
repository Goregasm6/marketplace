...
class ElectronicsCategory(CategoryKnowledge):
    ...
    keywords = ("iphone", "ipad", "laptop", "phone", "headphone", "tablet", "smartwatch")
    common_misspellings = ("iphon", "samsing", "mac book", "air pods")
    seasonality = "Strong Q4 gifting demand; phones also move well around launch cycles."
    repair_opportunities = ("battery replacement", "screen replacement", "charging-port cleaning")
    shipping_profile = ShippingProfile("small", "tracked parcel with insurance", "Verify activation locks and lithium-battery rules.")

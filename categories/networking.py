...
class NetworkingCategory(CategoryKnowledge):
    ...
    keywords = ("switch", "router", "firewall", "access point", "poe", "ethernet", "sfp", "wireless controller")
    ...
    repair_opportunities = ("fan replacement", "power-supply testing", "firmware reset", "port testing")
    shipping_profile = ShippingProfile("medium", "anti-static padded insured parcel", "Verify cloud/licensing release and include console accessories when available.")

...
class IndustrialCategory(CategoryKnowledge):
    ...
    brands = ("Siemens", "Allen-Bradley", "ABB", "Fanuc", "Omron", "Fluke", "Haas", "Mitsubishi")
    keywords = ("plc", "vfd", "servo", "hmi", "cnc", "welding", "compressor", "oscilloscope", "actuator")
    common_misspellings = ("allen bradley", "mitsu", "osciloscope", "variabel frequency drive")
    seasonality = "Stable year-round; plant shutdowns and capital-budget windows create liquidation opportunities."
    repair_opportunities = ("terminal cleanup", "capacitor replacement", "calibration", "bearing replacement")
    shipping_profile = ShippingProfile("heavy", "crated freight or foam-packed parcel", "Record part numbers and protect connectors; verify hazardous-material handling.")

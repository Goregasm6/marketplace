...
def most_profitable_categories(warehouse_path: str | Path | None = None) -> list[dict[str, Any]]:
    return _rows("""
...
def average_flipscore(warehouse_path: str | Path | None = None) -> list[dict[str, Any]]:
    return _rows("SELECT AVG(flip_score) AS average_flipscore FROM listing_facts WHERE flip_score IS NOT NULL", warehouse_path)


def median_asking_prices(warehouse_path: str | Path | None = None) -> list[dict[str, Any]]:
    return _rows("""
...
def keyword_performance(warehouse_path: str | Path | None = None) -> list[dict[str, Any]]:
...
def daily_listing_volume(warehouse_path: str | Path | None = None) -> list[dict[str, Any]]:
    return _rows("""
